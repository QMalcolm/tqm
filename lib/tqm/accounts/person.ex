defmodule Tqm.Accounts.Person do
  @moduledoc """
  Module for handling the association of people with the rest of the project
  """
  use Ecto.Schema
  ...
  schema "people" do
    ...
    field :role, Ecto.Enum, values: [:owner, :non_stranger, :stranger]
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Tqm.Repo)
  ...
  """
  def valid_password?(%Tqm.Accounts.Person{hashed_password: hashed_password}, password)
