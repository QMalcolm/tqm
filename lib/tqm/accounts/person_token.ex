defmodule Tqm.Accounts.PersonToken do
  @moduledoc """
  Module for handling tokens associated with peoples sessions
  """
  use Ecto.Schema
  import Ecto.Query
  alias Tqm.Accounts.PersonToken
  ...
  schema "people_tokens" do
    ...
    belongs_to :person, Tqm.Accounts.Person
