defmodule Tqm.Seeds do
  @moduledoc """
  Modulized version of the typical /priv/repo/seeds.ex
  This allows us to ssh into hosted instances of the TqmWeb app
  and run the seeds via running `Tqm.Seeds.desired_seeds`
  """
