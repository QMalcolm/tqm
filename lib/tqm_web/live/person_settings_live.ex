defmodule TqmWeb.PersonSettingsLive do
  ...
  def render(assigns) do
    ...
    <.simple_form
      ...
      action={~p"/people/log_in?_action=password_updated"}
      method="post"
  ...
  def mount(%{"token" => token}, _session, socket) do
    socket =
      case Accounts.update_person_email(socket.assigns.current_person, token) do
        :ok ->
  ...
  def handle_event("validate_email", params, socket) do
    ...
    email_changeset = Accounts.change_person_email(socket.assigns.current_person, person_params)
  ...
  def handle_event("validate_password", params, socket) do
    ...
    password_changeset =
      Accounts.change_person_password(socket.assigns.current_person, person_params)
    ...
    case Accounts.update_person_password(person, password, person_params) do
      {:ok, person} ->
        socket =
          ...
          |> assign(:password_changeset, Accounts.change_person_password(person, person_params))
