defmodule TqmWeb.PersonAuth do
  @moduledoc """
  Models for handling person authentication
  """

  use TqmWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_tqm_web_person_remember_me"
  ...
  def log_out_person(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      TqmWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_person:
      ...
      defmodule TqmWeb.PageLive do
        use TqmWeb, :live_view

        on_mount {TqmWeb.PersonAuth, :mount_current_person}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{TqmWeb.PersonAuth, :ensure_authenticated}] do
  ...
  defp mount_current_person(session, socket) do
    case session do
      ...
      %{} ->
        Phoenix.Component.assign_new(socket, :current_person, fn -> nil end)
    end
  end
