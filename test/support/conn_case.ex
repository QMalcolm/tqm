defmodule TqmWeb.ConnCase do
  ...
  by setting `use TqmWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import TqmWeb.ConnCase
    end
  end

  setup tags do
    Tqm.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_person(%{conn: conn}) do
    person = Tqm.AccountsFixtures.person_fixture()
  ...
  def log_in_person(conn, person) do
    token = Tqm.Accounts.generate_person_session_token(person)
