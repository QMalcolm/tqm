defmodule TqmWeb.PersonAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TqmWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_person/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TqmWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "on_mount: mount_current_person" do
    ...
    test "assigns nil to current_person assign if there isn't a valid person_token ", %{
      conn: conn
    } do
  ...
  describe "on_mount: ensure_authenticated" do
    test "authenticates current_person based on a valid person_token ", %{
      conn: conn,
      person: person
    } do
      person_token = Accounts.generate_person_session_token(person)
